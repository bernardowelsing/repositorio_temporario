...
-----------------------------------------------------------------------------------------------------------------------------------------
func = {}
Tunnel.bindInterface("ve_yellow",func)
-----------------------------------------------------------------------------------------------------------------------------------------
-- VARIAVEIS
-----------------------------------------------------------------------------------------------------------------------------------------
					...
					for l,w in pairs(policia) do
						...
						if player then
							async(function()
								...
								TriggerClientEvent('chatMessage',player,"190",{64,64,255},"O roubo começou no ^1Yellow^0, dirija-se até o local e intercepte o assaltante.")
...
function func.giveAward()
	...
	if user_id then
		local identity = vRP.getUserIdentity(user_id)
		local randmoney = math.random(110000,150000)
