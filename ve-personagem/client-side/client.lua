RegisterNetEvent("ve-personagem:startIntro")
RegisterNetEvent("ve-personagem:normalSpawn")
RegisterNetEvent("ve-personagem:characterCreate")
...
function drawscaleform(scaleform)
	...
	PushScaleformMovieFunctionParameterString("~r~Vanish Evolution")
	PushScaleformMovieFunctionParameterBool(true)
	PushScaleformMovieFunctionParameterString("~y~discord.gg/vanish")
...
-- EVENTS --
AddEventHandler("ve-personagem:startIntro", function()
	print("ve-personagem:startIntro")
	doStatus = -1
	SetTimeout(1000, function()
		TriggerServerEvent("ve-personagem:finishedIntro")
	end)
end)



AddEventHandler("ve-personagem:characterCreate", function()
	print("ve-personagem:characterCreate")
	doStatus = 1
...
AddEventHandler("ve-personagem:normalSpawn",function(firstspawn)
	if firstspawn then
...
RegisterNUICallback('cDoneSave', function(data, cb)
	...
	TriggerServerEvent("ve-personagem:finishedCharacter", characterNome, characterSobrenome, characterAge, currentCharacterMode)
end)
